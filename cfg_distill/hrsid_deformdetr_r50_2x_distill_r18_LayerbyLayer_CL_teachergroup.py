...
distiller = dict(
    type='Distiller',
    teacher_pretrained = 'work_dirs/hrsid_deformable-detr_r50_sar/best_coco_bbox_mAP_epoch_50.pth',
    init_student = False,
...
student_cfg = 'cfg_distill/deformable_detr/hrsid_deformable_detr_r50_16x2_50e_teacher.py'
teacher_cfg = 'cfg_distill/deformable_detr/hrsid_deformable_detr_r18_16x2_25e_student.py'
optimizer = dict(
    _delete_=True,
    type='AdamW',
    lr=2e-4,
